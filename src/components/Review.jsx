        ...
        <ContainerBox>
            <div className='lg:flex items-center justify-between gap-20 mt-20 mb-20'>
                <div className='lg:w-1/3'>
                    ...
                    <p className="font-serif">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est laboriosam assumenda pariatur voluptatem placeat consequuntur. Vel pariatur quis corporis animi! Suscipit sed repudiandae eligendi vel amet in ea iste laboriosam?</p>
